...
- (NSArray *)mas_makeConstraints:(void(^)(MASConstraintMaker *))block {
    ...
    //maker 有属性 view, constraints<NSMutableArray *>
    MASConstraintMaker *constraintMaker = [[MASConstraintMaker alloc] initWithView:self];
    //执行block,传入maker, maker是引用类型 故可以被改变.
    block(constraintMaker);
    //把修改后的最终 maker install, 即通过 maker.constraints<MASConstraint *> 开始给 maker.view 添加constraint.
